...
export const ELEMENT_COLORS: Record<string, Record<Strength, string>> = {
  木:   { 強: '#15803d', 中: '#22c55e', 弱: '#86efac' }, // 濃緑, グリーン, ミント
  火:   { 強: '#b91c1c', 中: '#ef4444', 弱: '#fda4af' }, // 濃赤, 赤, ピンク
  土:   { 強: '#b45309', 中: '#f59e42', 弱: '#fde68a' }, // 濃オレンジ, オレンジ, クリーム
  金:   { 強: '#000000', 中: '#262626', 弱: '#a3a3a3' }, // 黒, 濃グレー, グレー
  水:   { 強: '#1e40af', 中: '#3b82f6', 弱: '#7dd3fc' }, // 濃青, 青, ライトブルー
};
